...
- 수익 모델: (1) '가게 관리 이용권' — 사업자 인증이 승인된 업주가 비용을 지불하면 본인 가게의 메뉴·사진·소개글을 직접 등록/수정할 수 있습니다. 노출 순위나 검증 배지에는 전혀 영향을 주지 않습니다. (2) '맞춤추천' — 월 구독료를 낸 사용자에게 AI가 취향 기반으로 맛집을 우선 추천합니다.
